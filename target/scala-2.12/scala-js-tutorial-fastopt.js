...
$c_Lteste$.prototype = new $h_O();
$c_Lteste$.prototype.constructor = $c_Lteste$;
/** @constructor */
function $h_Lteste$() {
  /*<skip>*/
}
$h_Lteste$.prototype = $c_Lteste$.prototype;
$c_Lteste$.prototype.init___ = (function() {
  $n_Lteste$ = this;
  this.x$1 = this.mapa__sci_List();
  return this
});
$c_Lteste$.prototype.mapa1$1__p1__C__sci_List = (function(c) {
  if ((c < 91)) {
    var jsx$2 = this.mapa1$1__p1__C__sci_List((65535 & ((1 + c) | 0)));
    var jsx$1 = new $c_jl_Character().init___C(c);
    var this$3 = $m_sci_List$();
    return $as_sci_List(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(jsx$1, this$3.ReusableCBFInstance$2))
  } else {
    return $m_sci_Nil$()
  }
});
$c_Lteste$.prototype.mensagem$1__p1__sci_List__T = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var head = $uI(this$1.$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    var c = (65535 & head);
    var x = $as_T($g.String.fromCharCode(c));
    var this$10 = new $c_sci_StringOps().init___T(x);
    var x$1 = this.mensagem$1__p1__sci_List__T(tail);
    var that = new $c_sci_StringOps().init___T(x$1);
    var bf = $m_s_Predef$().StringCanBuildFrom$2;
    return $as_T($f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$10, that, bf))
  };
  var x$2 = $m_sci_Nil$();
  if (x$2.equals__O__Z(list)) {
    return ""
  };
  throw new $c_s_MatchError().init___O(list)
});
$c_Lteste$.prototype.criptografar__V = (function() {
  var h = $as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText").value);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText2").value = this.criptografe__sc_Seq__T($m_s_Predef$().wrapString__T__sci_WrappedString(h));
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText").value = ""
});
$c_Lteste$.prototype.descriptografar__V = (function() {
  try {
    var p = $as_T($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText2").value);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText").value = this.descriptografe__T__T(p);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myText2").value = ""
  } catch (e) {
    var e$2 = $m_sjsr_package$().wrapJavaScriptException__O__jl_Throwable(e);
    if ($is_jl_Exception(e$2)) {
      $as_jl_Exception(e$2);
      $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert("A mensagem n\u00e3o pode ser criptografada por n\u00e3o atender a uma mensagem v\u00e1lida.")
    } else {
      throw e
    }
  }
});
$c_Lteste$.prototype.dlistaInt__sc_Seq__sci_List = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var c = this$1.$$und1$f;
    ...
    var tail = $as_sc_Seq($as_T2(o8.get__O()).$$und2$f);
    if (($as_T($g.String.fromCharCode(head)) === "=")) {
      return $m_sci_Nil$()
    } else {
      var x$14 = this.ocorrencia__sc_Seq__sci_List__I(list, this.x$1);
      var jsx$1 = this.dlistaInt__sc_Seq__sci_List(tail);
      var this$10 = $m_sci_List$();
      return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$14, this$10.ReusableCBFInstance$2))
    }
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
    return $m_sci_Nil$()
  };
  throw new $c_s_MatchError().init___O(list)
});
$c_Lteste$.prototype.ocorrencia__sc_Seq__sci_List__I = (function(list, mapa) {
  var x1 = new $c_T2().init___O__O(list, mapa);
  var p2 = $as_sc_Seq(x1.$$und1$f);
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(p2)) {
    return 0
  };
  var p4 = $as_sc_Seq(x1.$$und1$f);
  var x$3 = $as_sci_List(x1.$$und2$f);
  var o12 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(p4);
  if ((!o12.isEmpty__Z())) {
    var this$1 = $as_T2(o12.get__O());
    var c = this$1.$$und1$f;
    if ((c === null)) {
      var head = 0
    } else {
    ...
    var tail = $as_sc_Seq($as_T2(o12.get__O()).$$und2$f);
    var c$1 = x$3.head__O();
    if ((c$1 === null)) {
      var jsx$1 = 0
    } else {
      var this$5 = $as_jl_Character(c$1);
      var jsx$1 = this$5.value$1
    };
    if ((head === jsx$1)) {
      return 0
    } else {
      var jsx$2 = new $c_jl_Character().init___C(head);
      var this$8 = $m_sc_Seq$();
      return ((1 + this.ocorrencia__sc_Seq__sci_List__I($as_sc_Seq(tail.$$plus$colon__O__scg_CanBuildFrom__O(jsx$2, this$8.ReusableCBFInstance$2)), $as_sci_List(x$3.tail__O()))) | 0)
    }
  };
  throw new $c_s_MatchError().init___O(x1)
});
$c_Lteste$.prototype.completar6__sci_List__sci_List = (function(list) {
  _completar6: while (true) {
    var x1 = list;
    var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(x1);
    if ((!o8.isEmpty__Z())) {
      var head = $as_T($as_T2(o8.get__O()).$$und1$f);
      var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
      if (($uI(head.length) === 6)) {
        var jsx$1 = this.completar6__sci_List__sci_List(tail);
        var this$2 = $m_sci_List$();
        return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(head, this$2.ReusableCBFInstance$2))
      } else {
        var x$16 = ("0" + head);
        var this$3 = $m_sci_List$();
        list = $as_sci_List(tail.$$plus$colon__O__scg_CanBuildFrom__O(x$16, this$3.ReusableCBFInstance$2));
        continue _completar6
      }
    };
    var x$2 = $m_sci_Nil$();
...
$c_Lteste$.prototype.listaBinario__sci_List__sci_List = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var head = $uI(this$1.$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    if (((head >= 0) && (head <= 127))) {
      var x$3 = this.range1__T__T($as_T(this.list2Binary__sci_List__sci_List(list).head__O()));
      var jsx$1 = this.listaBinario__sci_List__sci_List(tail);
      var this$2 = $m_sci_List$();
      return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$3, this$2.ReusableCBFInstance$2))
    } else if (((head >= 128) && (head <= 2047))) {
      var x$4 = this.range2__T__T($as_T(this.list2Binary__sci_List__sci_List(list).head__O()));
      var jsx$2 = this.listaBinario__sci_List__sci_List(tail);
      var this$3 = $m_sci_List$();
      return $as_sci_List(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(x$4, this$3.ReusableCBFInstance$2))
    } else {
      var x$5 = this.range3__T__T($as_T(this.list2Binary__sci_List__sci_List(list).head__O()));
      var jsx$3 = this.listaBinario__sci_List__sci_List(tail);
      var this$4 = $m_sci_List$();
      return $as_sci_List(jsx$3.$$plus$colon__O__scg_CanBuildFrom__O(x$5, this$4.ReusableCBFInstance$2))
    }
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
...
$c_Lteste$.prototype.range3__T__T = (function(s) {
  var x = this.caso0$2__p1__T__T(s);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var y = $as_T($f_sc_IndexedSeqOptimized__dropRight__I__O(this$2, 12));
  var this$4 = new $c_sci_StringOps().init___T(x);
  var $$this = this$4.repr$1;
  var until = $uI($$this.length);
  var z = $m_sci_StringOps$().slice$extension__T__I__I__T(this$4.repr$1, 4, until);
  var this$8 = new $c_sci_StringOps().init___T(z);
  var jsx$1 = $f_sc_IndexedSeqOptimized__dropRight__I__O(this$8, 6);
  var this$10 = new $c_sci_StringOps().init___T(z);
  var $$this$1 = this$10.repr$1;
  var until$1 = $uI($$this$1.length);
  return ((((("1110" + y) + "10") + jsx$1) + "10") + $m_sci_StringOps$().slice$extension__T__I__I__T(this$10.repr$1, 6, until$1))
});
$c_Lteste$.prototype.listBin2Int__sci_List__sci_List = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var head = $as_T($as_T2(o8.get__O()).$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    var x$7 = $m_jl_Integer$().parseInt__T__I__I(head, 2);
    var jsx$1 = this.listBin2Int__sci_List__sci_List(tail);
    var this$1 = $m_sci_List$();
    return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$7, this$1.ReusableCBFInstance$2))
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
    return $m_sci_Nil$()
...
$c_Lteste$.prototype.quebraString__T__sci_List = (function(s) {
  if (($uI(s.length) === 0)) {
    return $m_sci_Nil$()
  } else {
    var this$3 = new $c_sci_StringOps().init___T(s);
    if (($objectToString($f_sc_IndexedSeqOptimized__head__O(this$3)) === "0")) {
      var this$5 = new $c_sci_StringOps().init___T(s);
      var x$17 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$5.repr$1, 0, 8);
      var this$7 = new $c_sci_StringOps().init___T(s);
      var $$this = this$7.repr$1;
      var until = $uI($$this.length);
      var jsx$1 = this.quebraString__T__sci_List($m_sci_StringOps$().slice$extension__T__I__I__T(this$7.repr$1, 8, until));
      var this$10 = $m_sci_List$();
      return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$17, this$10.ReusableCBFInstance$2))
    } else {
      var this$12 = new $c_sci_StringOps().init___T(s);
      if (($objectToString($f_sc_IndexedSeqOptimized__head__O(this$12)) === "1")) {
        var this$14 = new $c_sci_StringOps().init___T(s);
        var x = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$14));
        var this$16 = new $c_sci_StringOps().init___T(x);
        var jsx$3 = ($objectToString($f_sc_IndexedSeqOptimized__head__O(this$16)) === "1")
      } else {
        var jsx$3 = false
      };
      if (jsx$3) {
        var this$18 = new $c_sci_StringOps().init___T(s);
        var x$1 = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$18));
        var this$20 = new $c_sci_StringOps().init___T(x$1);
        var x$2 = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$20));
        var this$22 = new $c_sci_StringOps().init___T(x$2);
        var jsx$2 = ($objectToString($f_sc_IndexedSeqOptimized__head__O(this$22)) === "0")
      } else {
        var jsx$2 = false
      };
      if (jsx$2) {
        var this$24 = new $c_sci_StringOps().init___T(s);
        var x$3 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$24.repr$1, 0, 8);
        var this$26 = new $c_sci_StringOps().init___T(x$3);
        var $$this$1 = this$26.repr$1;
        var until$1 = $uI($$this$1.length);
        var x$4 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$26.repr$1, 3, until$1);
        var this$37 = new $c_sci_StringOps().init___T(x$4);
        var this$31 = new $c_sci_StringOps().init___T(s);
        var x$5 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$31.repr$1, 0, 16);
        var this$33 = new $c_sci_StringOps().init___T(x$5);
        var $$this$2 = this$33.repr$1;
        var until$2 = $uI($$this$2.length);
        var x$6 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$33.repr$1, 10, until$2);
        var that = new $c_sci_StringOps().init___T(x$6);
        var bf = $m_s_Predef$().StringCanBuildFrom$2;
        var x$18 = $as_T($f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$37, that, bf));
        var this$39 = new $c_sci_StringOps().init___T(s);
        var $$this$3 = this$39.repr$1;
        var until$3 = $uI($$this$3.length);
        var jsx$4 = this.quebraString__T__sci_List($m_sci_StringOps$().slice$extension__T__I__I__T(this$39.repr$1, 16, until$3));
        var this$42 = $m_sci_List$();
        return $as_sci_List(jsx$4.$$plus$colon__O__scg_CanBuildFrom__O(x$18, this$42.ReusableCBFInstance$2))
      } else {
        var this$44 = new $c_sci_StringOps().init___T(s);
        var x$7 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$44.repr$1, 0, 8);
        var this$46 = new $c_sci_StringOps().init___T(x$7);
        var $$this$4 = this$46.repr$1;
        var until$4 = $uI($$this$4.length);
        var jsx$6 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$46.repr$1, 4, until$4);
        var this$50 = new $c_sci_StringOps().init___T(s);
        var x$8 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$50.repr$1, 0, 16);
        var this$52 = new $c_sci_StringOps().init___T(x$8);
        var $$this$5 = this$52.repr$1;
        var until$5 = $uI($$this$5.length);
        var jsx$5 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$52.repr$1, 10, until$5);
        var this$56 = new $c_sci_StringOps().init___T(s);
        var x$9 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$56.repr$1, 0, 24);
        var this$58 = new $c_sci_StringOps().init___T(x$9);
        var $$this$6 = this$58.repr$1;
        var until$6 = $uI($$this$6.length);
        var x$19 = ((("" + jsx$6) + jsx$5) + $m_sci_StringOps$().slice$extension__T__I__I__T(this$58.repr$1, 18, until$6));
        var this$62 = new $c_sci_StringOps().init___T(s);
        var $$this$7 = this$62.repr$1;
        var until$7 = $uI($$this$7.length);
        var jsx$7 = this.quebraString__T__sci_List($m_sci_StringOps$().slice$extension__T__I__I__T(this$62.repr$1, 24, until$7));
        var this$65 = $m_sci_List$();
        return $as_sci_List(jsx$7.$$plus$colon__O__scg_CanBuildFrom__O(x$19, this$65.ReusableCBFInstance$2))
      }
    }
  }
});
$c_Lteste$.prototype.doisUltimos__T__I = (function(s) {
  var x = $uI(s.length);
  var this$3 = new $c_sci_StringOps().init___T(s);
  var n = (((-2) + x) | 0);
  var $$this = this$3.repr$1;
  var until = $uI($$this.length);
  var p = $m_sci_StringOps$().slice$extension__T__I__I__T(this$3.repr$1, n, until);
  var this$7 = new $c_sci_StringOps().init___T(p);
  if (($objectToString($f_sc_IndexedSeqOptimized__head__O(this$7)) === "=")) {
    return 2
  } else {
    var this$9 = new $c_sci_StringOps().init___T(p);
    var x$1 = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$9));
    var this$11 = new $c_sci_StringOps().init___T(x$1);
    if (($objectToString($f_sc_IndexedSeqOptimized__head__O(this$11)) === "=")) {
      return 1
    } else {
      return 0
    }
...
$c_Lteste$.prototype.caso0$1__p1__T__T = (function(s) {
  _caso0: while (true) {
    var x1 = s;
    if ((x1 !== null)) {
      if (($uI(x1.length) === 11)) {
        return x1
      } else if (($uI(x1.length) < 11)) {
        s = ("0" + x1);
        continue _caso0
      } else {
        var this$4 = new $c_sci_StringOps().init___T(x1);
        s = $as_T($f_sc_IndexedSeqOptimized__tail__O(this$4));
        continue _caso0
      }
    } else {
      return ""
...
$c_Lteste$.prototype.mapa3$1__p1__C__sci_List = (function(c) {
  if ((c < 58)) {
    var jsx$2 = this.mapa3$1__p1__C__sci_List((65535 & ((1 + c) | 0)));
    var jsx$1 = new $c_jl_Character().init___C(c);
    var this$3 = $m_sci_List$();
    return $as_sci_List(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(jsx$1, this$3.ReusableCBFInstance$2))
  } else {
    $m_sci_List$();
    var array = [new $c_jl_Character().init___C(43), new $c_jl_Character().init___C(47)];
...
$c_Lteste$.prototype.concatenarElementos__sci_List__T = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var head = $as_T($as_T2(o8.get__O()).$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    return (("" + head) + this.concatenarElementos__sci_List__T(tail))
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
    return ""
...
$c_Lteste$.prototype.criptografe__sc_Seq__T = (function(list) {
  var a = this.listaInteiros__sc_Seq__sci_List(list);
  var b = this.listaBinario__sci_List__sci_List(a);
  var c = this.concatenarElementos__sci_List__T(b);
  var d = this.bit2Byte__T__T(c);
  var e = this.agrupar6__T__sci_List(d);
  var f = this.listBin2Int__sci_List__sci_List(e);
  var tam = (($uI(d.length) / 8) | 0);
  return (((tam % 3) === 0) ? this.mensagemCriptografada$1__p1__sci_List__T(f) : (((tam % 3) === 1) ? (this.mensagemCriptografada$1__p1__sci_List__T(f) + "==") : (this.mensagemCriptografada$1__p1__sci_List__T(f) + "=")))
});
$c_Lteste$.prototype.bit2Byte__T__T = (function(s) {
  return (((((($uI(s.length) / 8) | 0) % 3) | 0) === 0) ? s : (((((($uI(s.length) / 8) | 0) % 3) | 0) === 1) ? (s + "0000") : (s + "00")))
});
$c_Lteste$.prototype.main__AT__V = (function(args) {
  /*<skip>*/
});
$c_Lteste$.prototype.range2__T__T = (function(s) {
  var x = this.caso0$1__p1__T__T(s);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var jsx$1 = $f_sc_IndexedSeqOptimized__dropRight__I__O(this$2, 6);
  var this$4 = new $c_sci_StringOps().init___T(x);
  var $$this = this$4.repr$1;
  var until = $uI($$this.length);
  return ((("110" + jsx$1) + "10") + $m_sci_StringOps$().slice$extension__T__I__I__T(this$4.repr$1, 5, until))
});
$c_Lteste$.prototype.mensagemCriptografada$1__p1__sci_List__T = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var head = $uI(this$1.$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    var this$2 = this.x$1;
    var c = $f_sc_LinearSeqOptimized__apply__I__O(this$2, head);
    if ((c === null)) {
      var c$1 = 0
    } else {
      var this$4 = $as_jl_Character(c);
      var c$1 = this$4.value$1
    };
    return (("" + new $c_jl_Character().init___C(c$1)) + this.mensagemCriptografada$1__p1__sci_List__T(tail))
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
    return ""
...
$c_Lteste$.prototype.agrupar6__T__sci_List = (function(s) {
  if ((s === null)) {
  ...
  if ((s === "")) {
    ...
    var this$3 = new $c_sci_StringOps().init___T(s);
    var x$6 = $m_sci_StringOps$().slice$extension__T__I__I__T(this$3.repr$1, 0, 6);
    var this$5 = new $c_sci_StringOps().init___T(s);
    var $$this = this$5.repr$1;
    var until = $uI($$this.length);
    var jsx$1 = this.agrupar6__T__sci_List($m_sci_StringOps$().slice$extension__T__I__I__T(this$5.repr$1, 6, until));
    var this$8 = $m_sci_List$();
    return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(x$6, this$8.ReusableCBFInstance$2))
  }
});
$c_Lteste$.prototype.listaInteiros__sc_Seq__sci_List = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var c = this$1.$$und1$f;
    ...
    var tail = $as_sc_Seq($as_T2(o8.get__O()).$$und2$f);
    var jsx$1 = this.listaInteiros__sc_Seq__sci_List(tail);
    var this$4 = $m_sci_List$();
    return $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(head, this$4.ReusableCBFInstance$2))
  };
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(list)) {
    return $m_sci_Nil$()
...
$c_Lteste$.prototype.descriptografe__T__T = (function(s) {
  var v = this.doisUltimos__T__I(s);
  var a = this.dlistaInt__sc_Seq__sci_List($m_s_Predef$().wrapString__T__sci_WrappedString(s));
  var b = this.list2Binary__sci_List__sci_List(a);
  var c = this.completar6__sci_List__sci_List(b);
  var d = this.concatenarElementos__sci_List__T(c);
  var e = this.removerUltimos0__T__I__T(d, v);
  var f = this.quebraString__T__sci_List(e);
  var g = this.listBin2Int__sci_List__sci_List(f);
  return this.mensagem$1__p1__sci_List__T(g)
});
$c_Lteste$.prototype.mapa2$1__p1__C__sci_List = (function(c) {
  if ((c < 123)) {
    var jsx$2 = this.mapa2$1__p1__C__sci_List((65535 & ((1 + c) | 0)));
    var jsx$1 = new $c_jl_Character().init___C(c);
    var this$3 = $m_sci_List$();
    return $as_sci_List(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(jsx$1, this$3.ReusableCBFInstance$2))
  } else {
...
$c_Lteste$.prototype.mapa__sci_List = (function() {
  var x$12 = this.mapa1$1__p1__C__sci_List(65);
  var x$11 = this.mapa2$1__p1__C__sci_List(97);
  return this.mapa3$1__p1__C__sci_List(48).$$colon$colon$colon__sci_List__sci_List(x$11).$$colon$colon$colon__sci_List__sci_List(x$12)
});
$c_Lteste$.prototype.list2Binary__sci_List__sci_List = (function(list) {
  var o8 = $m_s_package$().$$plus$colon$1.unapply__sc_SeqLike__s_Option(list);
  if ((!o8.isEmpty__Z())) {
    var this$1 = $as_T2(o8.get__O());
    var head = $uI(this$1.$$und1$f);
    var tail = $as_sci_List($as_T2(o8.get__O()).$$und2$f);
    var x = $uD((head >>> 0));
    var jsx$1 = x.toString(2);
    var x$2 = $as_T(jsx$1);
    var jsx$2 = this.list2Binary__sci_List__sci_List(tail);
    var this$8 = $m_sci_List$();
    return $as_sci_List(jsx$2.$$plus$colon__O__scg_CanBuildFrom__O(x$2, this$8.ReusableCBFInstance$2))
  };
  var x$1 = $m_sci_Nil$();
  if (x$1.equals__O__Z(list)) {
    return $m_sci_Nil$()
  };
  throw new $c_s_MatchError().init___O(list)
});
$c_Lteste$.prototype.caso0$2__p1__T__T = (function(s) {
  _caso0: while (true) {
    var x1 = s;
    if ((x1 !== null)) {
      if (($uI(x1.length) === 16)) {
        return s
      } else if (($uI(x1.length) < 16)) {
        s = ("0" + x1);
        continue _caso0
      } else {
        var this$4 = new $c_sci_StringOps().init___T(x1);
...
$c_Lteste$.prototype.removerUltimos0__T__I__T = (function(list, v) {
  if ((v === 0)) {
    return list
  } else if ((v === 1)) {
    var this$2 = new $c_sci_StringOps().init___T(list);
    return $as_T($f_sc_IndexedSeqOptimized__dropRight__I__O(this$2, 2))
  } else {
    var this$4 = new $c_sci_StringOps().init___T(list);
    return $as_T($f_sc_IndexedSeqOptimized__dropRight__I__O(this$4, 4))
  }
});
$c_Lteste$.prototype.range1__T__T = (function(s) {
  _range1: while (true) {
    var x1 = s;
    if ((x1 !== null)) {
      if (($uI(x1.length) === 7)) {
...
var $d_Lteste$ = new $TypeData().initClass({
  Lteste$: 0
}, false, "teste$", {
  Lteste$: 1,
  O: 1
});
$c_Lteste$.prototype.$classData = $d_Lteste$;
var $n_Lteste$ = (void 0);
function $m_Lteste$() {
  if ((!$n_Lteste$)) {
    $n_Lteste$ = new $c_Lteste$().init___()
  };
  return $n_Lteste$
}
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.descript = (function() {
  $m_Lteste$().descriptografar__V()
});
$e.cript = (function() {
  $m_Lteste$().criptografar__V()
});
$m_Lteste$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
